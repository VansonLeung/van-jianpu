...
- Simple Jianpu rendering is a proposal at this stage: generate an interactive SVG preview from the existing tokens. See [JIANPU_RENDERING_PROPOSAL.md](JIANPU_RENDERING_PROPOSAL.md).
